    ...
    <div id="templatemo_banner">
    	...
    	<div id="templatemo_menu">
            <ul style="background-color:black;">
                ...
                <li><a href="#bookings" onClick="generateReport();">Bookings</a></li>
    ...
    <div id="templatemo_content">
    	...
    	<div id="content_left">
        	<div class="content_left_section">
            	<div class="content_title_01" id="bookings">Booking</div>
           ...
           <label style="color:white; font-size:15px;">Check in:</label>
			 ...
			 /*<span class="glyphicon glyphicon-calendar" style="">
                    ...
                    <input type="date" name="check-in" value="check-in" style="margin-left:12px;margin-top: 17px;">
                           
                      </div>
                        
                        <div class="form_row" style="    margin-bottom: 16px;" >
                           ...
                           <select name="No."style="width: 30px;margin-left: 13px; ">
								  <option value="1">1</option>
								  <option value="2">2</option>
								  <option value="3">3</option>
								  <option value="4">4</option>
						...
						<a onclick="myfunction();"  class="btn btn-success" role="button" style="color:white;">check availability</a>&nbsp;
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content"id="my" >
        ...
        <img src="images\YOLO-TRAVEL-LOGO.png"   style="height: 50px;
...
<a  href="sign.html" class="btn btn-danger" role="button" style="color:white;">Sign Up</a></center><br>
